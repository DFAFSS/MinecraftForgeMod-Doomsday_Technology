...
public class ShredderguiScreen extends AbstractContainerScreen<ShredderguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("doomsday_technology:textures/screens/shreddergui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, Component.translatable("gui.doomsday_technology.shreddergui.label_forging_press"), 6, 6, -12829636);
	}
