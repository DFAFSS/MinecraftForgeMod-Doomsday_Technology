...
import net.mcreator.doomsdaytechnology.procedures.FetchRFProcedure;
...
public class ForgingpressguiScreen extends AbstractContainerScreen<ForgingpressguiMenu> {
	private final static HashMap<String, Object> guistate = ForgingpressguiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ForgingpressguiScreen(ForgingpressguiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("doomsday_technology:textures/screens/forgingpressgui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack,
				...
				FetchRFProcedure.execute(world, x, y, z), 6, 70, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.doomsday_technology.forgingpressgui.label_forging_press"), 6, 6, -12829636);
	}
